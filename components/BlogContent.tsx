...
export default function BlogContent({ post, preview }: PostProps) {
    ...
    <div className={"markdown block mx-auto border-2 dark:border-orange-400 border-orange-700 rounded-3xl md:p-4 max-md:py-4 p-1 max-md:w-screen my-5"} dangerouslySetInnerHTML={{ __html: converter.makeHtml(post.post_content) }}>   
    </div>
