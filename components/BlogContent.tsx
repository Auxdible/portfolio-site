...
type PostProps = { post: posts, ref?: MutableRefObject<any> }
export default function BlogContent({ post, ref }: PostProps) {
    return (<main ref={ref} className={"flex flex-col items-center min-h-screen justify-center max-w-7xl w-fit mx-auto"}>
    ...
    <div className={"markdown block mx-auto border-2 dark:border-orange-400 border-orange-700 rounded-3xl p-4 w-fit my-5"} dangerouslySetInnerHTML={{ __html: converter.makeHtml(post.post_content) }}>   
    </div>
    </main>)
}