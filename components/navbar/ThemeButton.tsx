...
export default function ThemeButton() {
    ...
    return (<button aria-label={"Change Theme"} onClick={() => setTheme(theme == "dark" ? "light" : "dark")} className={"group h-[40px] w-[40px] border dark:border-gray-200 border-gray-700 dark:bg-black bg-white dark:hover:text-orange-400 hover:text-orange-700 relative transition-all rounded-xl"}>
