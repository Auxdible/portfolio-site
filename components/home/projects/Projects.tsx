...
export default function Projects(){
  ...
  whileInView={{ opacity: 1, transform: "translateY(0)" }} transition={{ duration: 1 }} viewport={{ once: true }} className={"text-8xl text-center font-raleway text-title w-full h-32"}>My Projects</motion.h1>
