...
export default function BlogPosts() {
    ...
    <section>
    <motion.h1 initial={{ opacity: 0, transform: "translateY(-4rem)" }}
  whileInView={{ opacity: 1, transform: "translateY(0)" }} transition={{ duration: 1 }} viewport={{ once: true }} className={"text-8xl max-md:text-6xl text-center font-raleway text-title w-full py-2 z-10"}>My Blog</motion.h1>
    </section>
    <section>
