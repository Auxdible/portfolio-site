  ...
  return (
    <header className="flex flex-row max-md:flex-col min-h-screen w-full items-center mx-auto max-md:my-16">
      <div className={"flex flex-col content-center gap-5 flex-1 flex-grow font-roboto text-2xl text"}>
          ...
          <h1 className={"text-8xl pt-4 font-montserrat text-primary"}>Auxdible</h1>
          <p className={"text-4xl font-montserrat py-2"}>Full Stack Developer</p>
          </section>
          <button onClick={() => changeGradient() } className={"mx-auto w-fit border italic dark:border-orange-400 border-orange-700 p-1 rounded-lg"}>Change glasses gradient 😎</button>
      </div>
