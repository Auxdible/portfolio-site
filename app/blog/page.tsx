...
export default function Blog() {
    ...
    <div className={"leading-3 mx-auto text-center font-lato text-2xl text mt-40 mb-10  "}>
        <h1 className={"text-6xl max-sm:text-5xl font-raleway font-bold h-16 text-title my-5"}>Blog Posts</h1>
